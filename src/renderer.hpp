...
public:
    void Init(QOpenGLFunctions * glWidget)
    {
        ...
        m_bgTexture = new QOpenGLTexture(QImage(":/data/models/background.png"));
        m_bgTexture->setMagnificationFilter(QOpenGLTexture::Nearest);
    }
    ...
    {
        m_texturedRect->Render(m_explosionTexture, QVector2D(obj.m_position.x(), obj.m_position.y()), QSize(1600,1200), m_screenSize, Settings::resolutionRate, false, obj.m_frame, obj.m_frameCount);
    }
    ...
    void DrawRealBackground()
    {
        ...
        m_texturedRect->Render(m_bgTexture, QVector2D(200, 200), QSize(425, 425), m_screenSize, 2);
